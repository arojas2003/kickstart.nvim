...
> the template or fork), replace `arojas2003` with `<your_github_username>`
> in the commands below

<details><summary> Linux and Mac </summary>

```sh
git clone https://github.com/arojas2003/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/arojas2003/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/arojas2003/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
